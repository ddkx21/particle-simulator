...
class TestDirectForces:
    def test_single_particle_zero_force(self) -> None:
        fc = DirectDropletForceCalculator(num_particles=4, L=1.0, boundary_mode="open")
    ...
    def test_returns_correct_shape(self) -> None:
        fc = DirectDropletForceCalculator(num_particles=8, L=1.0, boundary_mode="open")
...
class TestPeriodicBoundary:
    def test_periodic_changes_force_vs_open(self) -> None:
        ...
        fc_open = DirectDropletForceCalculator(num_particles=4, L=1.0, boundary_mode="open")
        f_open = fc_open.calculate(positions, radii)

        fc_per = DirectDropletForceCalculator(num_particles=4, L=1.0, boundary_mode="periodic")
