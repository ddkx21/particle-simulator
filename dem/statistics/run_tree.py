"""
Сбор статистики: Tree-метод (NUM_RUNS реализаций).

Запуск: python statistics/run_tree.py
...
def run_single_simulation(cfg, box_size):
    """Запуск одной симуляции tree-методом."""
...
def main():
    ...
    print(f"Tree: theta={tree_cfg['theta']}, mpl={tree_cfg['mpl']}")
